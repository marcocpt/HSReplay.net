    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('build', models.PositiveIntegerField()),
                ('adventure', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='scenarios.Adventure')),
            ],
        ),
        migrations.CreateModel(
            name='Wing',
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('build', models.PositiveIntegerField()),
                ('adventure', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='scenarios.Adventure')),
                ('ownership_prereq_wing', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='scenarios.Wing')),
            ],
        ),
        migrations.AddField(
            model_name='scenario',
